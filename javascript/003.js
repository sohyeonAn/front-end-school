...
// document.write(number, '<br>'); // 13.3
// document.write(0.1 + 0.2 == 0.3, '<br>'); // false, 대체 왜..?
// document.write(9999999999999999999, '<br>'); // 10000000000000000000

// // 최대 표현가능 수 : 2^53-1
// const val1 = BigInt(9999999999999999999);
// document.write(val1, '<br>'); // 10000000000000000000
...
document.write(`Number(nFloat)) : ${Number(nFloat)} <br>`);
